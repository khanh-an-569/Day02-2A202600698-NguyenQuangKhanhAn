# Day 02 Lab — Individual Reflection
...
Tôi sẽ challenge mạnh hơn về scope và tính khả thi của từng problem, đặc biệt là việc liệu vấn đề đó có đủ cụ thể để build MVP và validate nhanh hay không.
